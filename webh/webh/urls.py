...
urlpatterns = [
    ...
    path('addQuestions/', teacherView.addQuestions.as_view(), name="addQuestions"),
    ...
    path('showTestData/', teacherView.showTestData.as_view(), name="showTestData"),
    path('addTestData/', teacherView.addTestData.as_view(), name="addTestData"),
    path('deleteTestData/', teacherView.deleteTestData.as_view(), name="deleteTestData"),
